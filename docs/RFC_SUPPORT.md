...
This matrix describes the local `0.1.0` initial-acceptance behavior. “Partial”
...
| §4.3.2 Handling received validation requests | Not applicable | MoonCache is initially a client/runtime layer | no origin server implementation |
| §4.3.4 Freshening stored responses with 304 | Implemented | `merge_not_modified` | 13 direct 304 tests plus runtime tests |
| §4.4 Invalidation | Implemented for initial scope | `invalidation.mbt` | unsafe target and safe same-origin related URIs |
...
| Range / 206 interactions | Not implemented | — | explicitly outside initial scope |
